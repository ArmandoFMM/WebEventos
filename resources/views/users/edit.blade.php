        ...
        <div class="col-lg-12 col-md-12 col-sm-9 col-xs-12 col-lg-offset-1">
            <div class="panel panel-info ">
                <div class="panel-body">
                    <h3 class="panel-title">Editar Utilizador</h3>
                </div>
            </div>
            <!--  <div class="jumbotron"> -->
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12">
                    {!! Form::text('username', $user->username, array('class'=>'form-control input-lg','id'=>'name', 'placeholder'=>'Informe o seu username')) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12">
                    {!!  Form::email('email',$user->email,array('class'=>'form-control input-lg', 'id'=>'email',
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12">
                    {!! Form::select('role_id',$roles, $user->role->designacao, array('class'=>'form-control input-lg dropdown-content', 'placeholder'=>'--selecione--')) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12">
                    {{Form::text('telefone', $user->telefone,array('class'=>'form-control input-lg','id'=>'telefone','placeholder'=>'Informe o seu número de telefone'))}}
                </div>
            </div>

            <div class="form-group">
                <div class="col-xs-12 col-md-6">
                    {!! Form::submit('Actualizar', array('class'=>'btn btn-primary btn-lg btn-block')) !!}
                </div>
